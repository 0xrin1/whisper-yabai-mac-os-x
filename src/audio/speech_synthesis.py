...
CASUAL_RESPONSES = {
    ...
    "jarvis_startup": [
        "Hey, I'm up and running. Ready whenever you are.",
        "Hey there! Got the coffee brewing yet? I'm ready to help.",
        "Morning! Or whatever time it is. I'm here now.",
        "Just booted up. What are we working on today?",
        "I'm here and ready to help. Let me know what you need.",
        "Back online. What did I miss?",
        "Hey! Hope you're having a good day. Let me know if you need anything.",
        "I'm here! What's on your mind?",
        "Ready to help with whatever you need today.",
        "All set to go. Just let me know what you're working on.",
    ],
}
