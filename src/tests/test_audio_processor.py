...
class TestAudioProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Patch notification
        self.notify_patch = patch('src.audio.audio_processor.notify_processing', MagicMock())
    ...
    def test_llm_dynamic_response(self):
        ...
        self.mock_interpreter.generate_dynamic_response.assert_called_with("make this window bigger")
