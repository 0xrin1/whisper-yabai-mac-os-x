...
from src.tests.common.base import BaseTestCase
...
class TestStateManager(BaseTestCase):
    ...
    def test_callback_error_handling(self):
        ...
        with patch("logging.Logger.error") as mock_error:
            ...
            mock_error.assert_called_with("Error in mute callback: Test exception")
        ...
        with patch("logging.Logger.error") as mock_error:
            self.state_manager.start_recording()
            # Check that error was logged
            mock_error.assert_called_with("Error in recording callback: Test exception")
